			...
			<div id="nav-container">
				...
				<div className="nav-slider nav-sliding">
					...
					<ul className="nav-list-wrapper">
						<li className="nav-list-item"><button className="nav-link-item" >HOME</button></li>
						<li className="nav-list-item"><button className="nav-link-item" >DISCUSSION</button></li>
						<li className="nav-list-item"><button className="nav-link-item">SETTING</button></li>
						<li className="nav-list-item"><button className="nav-link-item" >HELP</button></li>
						<li className="nav-list-item"><button className="nav-link-item" >ABOUT</button></li>
						<li className="nav-list-item"><button className="nav-link-item" >Documentation</button></li>
						<li className="nav-list-item"><button className="nav-link-item" >LOGOUT</button></li>
					</ul>
